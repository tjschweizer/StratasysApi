...
#	((DRAWNS,u'id'), None): cnv_nonNegativeInteger,   # ?? line 6581 in RNG
	...
	((DRAWNS,u'main-page-name'), None): cnv_StyleNameRef,
...
#	((FORMNS,u'current-value'), None): cnv_time,
	...
	((FORMNS,u'main-fields'), None): cnv_string,
...
#	((FORMNS,u'value'), None): cnv_time,
	...
	((PRESENTATIONNS,u'main-element'), None): cnv_IDREF,
	...
	((STYLENS,u'main-page-name'), None): cnv_StyleNameRef,
...
#	((TEXTNS,u'id'), None): cnv_string,
	...
	((TEXTNS,u'main-page-name'), None): cnv_StyleNameRef,
